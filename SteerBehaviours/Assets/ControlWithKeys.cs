...
public class ControlWithKeys : MonoBehaviour {
	...
	void Update () {
        ...
        transform.Rotate(0f,0f, Input.GetAxis("Horizontal") * Time.deltaTime);// get the wasd or UP/DOWN/LEFT/RIGHT input and move 1 pixel accordingly, also in relation to your system's time.
